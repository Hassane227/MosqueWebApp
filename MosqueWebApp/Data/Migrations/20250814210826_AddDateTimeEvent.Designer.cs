...
namespace MosqueWebApp.Data.Migrations
{
    ...
    [Migration("20250814210826_AddDateTimeEvent")]
    partial class AddDateTimeEvent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MosqueWebApp.Models.Mosquee", b =>
                {
                    ...
                    b.Property<string>("AdminMosqueeId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MosqueWebApp.Models.Mosquee", b =>
                {
                    b.HasOne("MosqueWebApp.Models.ApplicationUser", "AdminMosquee")
                        .WithMany()
                        .HasForeignKey("AdminMosqueeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MosqueWebApp.Models.ApplicationUser", "Imam")
                        .WithMany()
                        .HasForeignKey("ImamId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("AdminMosquee");
